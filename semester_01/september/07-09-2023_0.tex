...
$\int\int\limits_{D} f(x, y) \diff x \diff y = \int\limits_{0}^{1} \diff x \int\limits_{x^2}^{\sqrt{x}} f(x, y) \diff y$

$\int\int\limits_{D} f(x, y) \diff x \diff y = \int\limits_{0}^{1} \diff y \int\limits_{\sqrt{x}}^{x^2} f(x, y) \diff x$
